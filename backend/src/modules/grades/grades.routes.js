...
router.post("/", authorize("formador", "coordenador"), auditLog("grade.create"), gradesController.createGrade);

// Lançar notas em lote (útil para planilha)
router.post("/bulk", authorize("formador", "coordenador"), auditLog("grade.bulk_create"), gradesController.bulkCreateGrades);
...
// Atualizar nota
router.patch("/:id", authorize("formador", "coordenador"), auditLog("grade.update"), gradesController.updateGrade);
