...
router.post("/", authorize("formador", "coordenador"), auditLog("assessment.create"), assessmentsController.createAssessment);
...
router.delete("/:id", authorize("formador", "coordenador"), auditLog("assessment.delete"), assessmentsController.deleteAssessment);
