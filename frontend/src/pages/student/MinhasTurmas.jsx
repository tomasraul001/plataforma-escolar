    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <button
          ...
          className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg font-medium text-sm transition-colors self-start sm:self-auto"
        >
          + Entrar na Turma
        </button>
      </div>
      ...
      {myClasses.length === 0 ? (
        <div className="bg-white/60 backdrop-blur-md rounded-xl border border-white/40 shadow-sm p-12 text-center">
          ...
          <p className="text-gray-600 mb-6 text-sm">Entre em uma turma usando a chave que seu formador te deu.</p>
          <button
            onClick={() => navigate("/formando/entrar-turma")}
