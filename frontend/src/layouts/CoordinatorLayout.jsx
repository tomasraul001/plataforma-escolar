...
export default function CoordinatorLayout() {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <aside className="fixed inset-y-0 left-0 z-50 w-64 bg-blue-950 transform transition-transform duration-300 ease-in-out lg:translate-x-0">
        <div className="flex h-16 items-center justify-between px-6 border-b border-blue-800">
          <span className="text-xl font-bold text-white">Coordenação</span>
        </div>
      ...
      <main className="lg:ml-64 flex-1 min-h-screen">
        <header className="sticky top-0 z-40 bg-white shadow-sm border-b border-gray-200">
          <div className="flex h-16 items-center justify-between px-6">
            <h1 className="text-xl font-semibold text-gray-800">Painel do Coordenador</h1>
